...
package at.rayman.projecttabs.yoinked.tabs.impl.singleRow;

import com.intellij.ui.ExperimentalUI;
import at.rayman.projecttabs.yoinked.tabs.TabInfo;
import at.rayman.projecttabs.yoinked.tabs.TabsUtil;
import at.rayman.projecttabs.yoinked.tabs.impl.*;
import at.rayman.projecttabs.yoinked.tabs.impl.singleRow.SingleRowLayoutStrategy;
...
public abstract class SingleRowLayout extends TabLayout {
  ...
  protected boolean checkLayoutLabels(SingleRowPassInfo data) {
    ...
    if (!myTabs.getForcedRelayout$projectTabs() &&
