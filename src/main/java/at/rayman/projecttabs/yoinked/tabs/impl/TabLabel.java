...
import at.rayman.projecttabs.yoinked.tabs.JBTabsEx;
import at.rayman.projecttabs.yoinked.tabs.TabInfo;
import at.rayman.projecttabs.yoinked.tabs.UiDecorator;
import at.rayman.projecttabs.yoinked.tabs.impl.*;
...
public class TabLabel extends JPanel implements Accessible, DataProvider {
  ...
  protected void paintFadeout(final Graphics g) {
    ...
    try {
      ...
      else if (myTabs.getEffectiveLayout$projectTabs().isScrollable() &&
  ...
  /**
   * @deprecated specify {@link UiDecorator.UiDecoration#contentInsetsSupplier} instead
   */
    ...
    public void layoutContainer(Container parent) {
      ...
      synchronized (parent.getTreeLock()) {
        if (!myInfo.isPinned() && myTabs != null &&
            myTabs.getEffectiveLayout$projectTabs().isScrollable() &&
